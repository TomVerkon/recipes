...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	private List<Recipe> getRecipes() {
		...
		if (!eachUomOptional.isPresent()) {
			throw new ObjectNotFoundException(EACH,
					UnitOfMeasure.class.getSimpleName());
		}
		...
		if (!tableSpoonUomOptional.isPresent()) {
			throw new ObjectNotFoundException(TABLESPOON,
					UnitOfMeasure.class.getSimpleName());
		}
		...
		if (!teaSpoonUomOptional.isPresent()) {
			throw new ObjectNotFoundException(TEASPOON,
					UnitOfMeasure.class.getSimpleName());
		}
		...
		if (!dashUomOptional.isPresent()) {
			throw new ObjectNotFoundException(DASH,
					UnitOfMeasure.class.getSimpleName());
		}
		...
		if (!pintUomOptional.isPresent()) {
			throw new ObjectNotFoundException(PINT,
					UnitOfMeasure.class.getSimpleName());
		}
		...
		if (!cupsUomOptional.isPresent()) {
			throw new ObjectNotFoundException(CUP,
					UnitOfMeasure.class.getSimpleName());
		}
		...
		if (!americanCategoryOptional.isPresent()) {
			throw new ObjectNotFoundException(AMERICAN,
		...
		if (!mexicanCategoryOptional.isPresent()) {
			throw new ObjectNotFoundException(MEXICAN,
					Category.class.getSimpleName());
		}
		...
		tacosRecipe.addIngredient(
				new Ingredient("Sugar", new BigDecimal(1), teapoonUom));
		tacosRecipe.addIngredient(
				new Ingredient("Salt", new BigDecimal(".5"), teapoonUom));
		...
		tacosRecipe.addIngredient(new Ingredient("Roughly chopped cilantro",
				new BigDecimal(4), eachUom));
		tacosRecipe.addIngredient(
				new Ingredient("cup sour cream thinned with 1/4 cup milk",
